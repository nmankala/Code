...
namespace IMD.SP.SiteColumnAndContentTypes
{
    public static class TokenHelper
    {
        ...
        /// <param name="targetRealm">Realm to use for the access token's nameid and audience</param>
        /// <returns>An access token with an audience of the target principal</returns>
        public static OAuth2AccessTokenResponse GetAppOnlyAccessToken1(
            string targetPrincipalName,
            string targetHost,
            string targetRealm,
            string targetClientID,
            string targetSecreteID)
        {
            ...
            string resource = GetFormattedPrincipal(targetPrincipalName, targetHost, targetRealm);
            string clientId = GetFormattedPrincipal(targetClientID, HostedAppHostName, targetRealm);

            OAuth2AccessTokenRequest oauth2Request = OAuth2MessageFactory.CreateAccessTokenRequestWithClientCredentials(clientId, targetSecreteID, resource);
            oauth2Request.Resource = resource;
